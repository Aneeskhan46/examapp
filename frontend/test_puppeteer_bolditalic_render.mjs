...
(async () => {
  ...
  await page.setContent('<!DOCTYPE html><html><head><script defer src="https://unpkg.com/mathlive@0.94.0"></script></head><body><math-field id="mf">\\boldsymbol{\\mathit{a}}</math-field></body></html>');
