...
const CHEM_GROUPS = [

  {
    ...
    items: [
      ...
      { label: (<svg width="26" height="26" viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="3" style={{ display: 'inline-block', verticalAlign: 'middle', color: '#222' }}><line x1="8" y1="32" x2="46" y2="32" stroke="#222" strokeWidth="4" strokeLinecap="round"/><path d="M40 22L54 32L40 42V34H30V30H40V22Z" fill="#222" stroke="none"/></svg>), insert: '\\rightarrow', cls: 'symbol', directInsert: true, action: 'INSERT_CUSTOM', title: 'Right Arrow' },
      // { label: '→', insert: '\\rightarrow', title: 'Right arrow' },
     { label: (<svg width="26" height="26" viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="3" style={{ display: 'inline-block', verticalAlign: 'middle', color: '#2E7D32' }}><rect x="24" y="10" width="8" height="14" rx="1"/><line x1="8" y1="40" x2="44" y2="40" stroke="#222" strokeWidth="4" strokeLinecap="round"/><path d="M40 30L54 40L40 50V42H32V38H40V30Z" fill="#222" stroke="none"/></svg>), insert: '\\overset{#?}{\\rightarrow}', cls: 'template', directInsert: true, action: 'INSERT_CUSTOM', title: 'forward reaction  with upper script' },
      // { label: '→̅', insert: '\\overset{#?}{\\rightarrow}', isWidget: true, title: 'Right arrow with overscript' },
      { label: (<svg width="26" height="26" viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="3" style={{ display: 'inline-block', verticalAlign: 'middle', color: '#2E7D32' }}><line x1="8" y1="24" x2="46" y2="24" stroke="#222" strokeWidth="4" strokeLinecap="round"/><path d="M40 14L54 24L40 34V26H30V22H40V14Z" fill="#222" stroke="none"/><rect x="28" y="40" width="8" height="14" rx="1"/></svg>), insert: '\\underset{#?}{\\rightarrow}', cls: 'template', directInsert: true, action: 'INSERT_CUSTOM', title: 'forward reaction with under script' },
      // { label: '→̲', insert: '\\underset{#?}{\\rightarrow}', isWidget: true, title: 'Right arrow with underscript' },
      { label: (<svg width="26" height="26" viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="3" style={{ display: 'inline-block', verticalAlign: 'middle', color: '#222' }}><line x1="8" y1="24" x2="52" y2="24" stroke="#222" strokeWidth="4" strokeLinecap="round"/><path d="M42 16L52 24L42 24" stroke="#222" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" fill="none"/><line x1="12" y1="40" x2="56" y2="40" stroke="#222" strokeWidth="4" strokeLinecap="round"/><path d="M22 48L12 40L22 40" stroke="#222" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" fill="none"/></svg>), insert: '\\rightleftharpoons', cls: 'symbol', directInsert: true, action: 'INSERT_CUSTOM', title: 'Right Left Harpoons' },
