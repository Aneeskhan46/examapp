    ...
    items: [
...

      {
        type: 'sep', cols: 1, fontSize: '8px', cls: 'cme-matrix-subgroup', moreCols: 3, moreItems: [
          // sub addition
          { label: (<svg width="26" height="30" viewBox="0 -6 64 72" fill="none" stroke="currentColor" strokeWidth="3" style={{ display: 'inline-block', verticalAlign: 'middle', color: '#2E7D32', overflow: 'visible' }}><rect x="40" y="-2" width="10" height="16" rx="1" /><rect x="40" y="18" width="10" height="16" rx="1" /><rect x="40" y="46" width="10" height="16" rx="1" /><line x1="8" y1="38" x2="54" y2="38" stroke="#222" strokeWidth="4" strokeLinecap="round" /></svg>), insert: '\\class{cme-col-op-wrapper}{\\class{cme-col-op-val1}{#?}\\class{cme-col-op-op}{\\,}\\class{cme-col-op-val2}{#?}\\class{cme-col-op-result}{#?}}', cls: 'template', directInsert: true, action: 'INSERT_CUSTOM', title: 'Fraction Template' },
          { label: (<svg width="26" height="30" viewBox="0 -6 64 72" fill="none" stroke="currentColor" strokeWidth="3" style={{ display: 'inline-block', verticalAlign: 'middle', color: '#2E7D32', overflow: 'visible' }}><rect x="40" y="-2" width="10" height="16" rx="1" /><rect x="40" y="18" width="10" height="16" rx="1" /><rect x="40" y="46" width="10" height="16" rx="1" /><line x1="8" y1="38" x2="54" y2="38" stroke="#222" strokeWidth="4" strokeLinecap="round" /><line x1="10" y1="26" x2="26" y2="26" stroke="#222" strokeWidth="4" strokeLinecap="round" /></svg>), insert: '\\class{cme-col-op-wrapper}{\\class{cme-col-op-val1}{#?}\\class{cme-col-op-op}{-}\\class{cme-col-op-val2}{#?}\\class{cme-col-op-result}{#?}}', cls: 'template', directInsert: true, action: 'INSERT_CUSTOM', title: 'Fraction with Subtraction' },
          { label: (<svg width="26" height="30" viewBox="0 -6 64 72" fill="none" stroke="currentColor" strokeWidth="3" style={{ display: 'inline-block', verticalAlign: 'middle', color: '#2E7D32', overflow: 'visible' }}><rect x="40" y="-2" width="10" height="16" rx="1" /><rect x="40" y="18" width="10" height="16" rx="1" /><rect x="40" y="46" width="10" height="16" rx="1" /><line x1="8" y1="38" x2="54" y2="38" stroke="#222" strokeWidth="4" strokeLinecap="round" /><line x1="11" y1="19" x2="25" y2="33" stroke="#222" strokeWidth="4" strokeLinecap="round" /><line x1="25" y1="19" x2="11" y2="33" stroke="#222" strokeWidth="4" strokeLinecap="round" /></svg>), insert: '\\class{cme-col-op-wrapper}{\\class{cme-col-op-val1}{#?}\\class{cme-col-op-op}{×}\\class{cme-col-op-val2}{#?}\\class{cme-col-op-result}{#?}}', cls: 'template', directInsert: true, action: 'INSERT_CUSTOM', title: 'Fraction with Multiplication' },

          //long divison with four terms
          { label: (<svg width="26" height="30" viewBox="0 0 64 72" fill="none" stroke="currentColor" strokeWidth="3" style={{ display: 'inline-block', verticalAlign: 'middle', color: '#2E7D32' }}><rect x="4" y="8" width="10" height="16" rx="1" /><path d="M30 4V30H56" stroke="#222" strokeWidth="4" fill="none" strokeLinecap="round" /><rect x="40" y="8" width="10" height="16" rx="1" /><rect x="40" y="40" width="10" height="16" rx="1" /></svg>), insert: '\\class{cme-lshape-wrapper}{\\class{cme-lshape-div1}{#?}\\class{cme-lshape-val1}{#?}\\class{cme-lshape-val2}{#?}}', cls: 'template', directInsert: true, action: 'INSERT_CUSTOM', title: 'Long Division' },
          { label: (<svg width="26" height="30" viewBox="0 0 64 72" fill="none" stroke="currentColor" strokeWidth="3" style={{ display: 'inline-block', verticalAlign: 'middle', color: '#2E7D32' }}><rect x="4" y="8" width="10" height="16" rx="1" /><rect x="4" y="44" width="10" height="16" rx="1" /><path d="M30 4V36H58" stroke="#222" strokeWidth="4" fill="none" strokeLinecap="round" /><rect x="44" y="8" width="10" height="16" rx="1" /><rect x="44" y="44" width="10" height="16" rx="1" /></svg>), insert: '\\class{cme-lshape-wrapper}{\\class{cme-lshape-div1}{#?}\\class{cme-lshape-val1}{#?}\\class{cme-lshape-div2}{#?}\\class{cme-lshape-val2}{#?}}', cls: 'template', directInsert: true, action: 'INSERT_CUSTOM', title: 'Long Division with Four Terms' },
      ...
      //column addition
      { label: (<svg width="26" height="30" viewBox="0 -6 64 72" fill="none" stroke="currentColor" strokeWidth="3" style={{ display: 'inline-block', verticalAlign: 'middle', color: '#2E7D32', overflow: 'visible' }}><rect x="40" y="-2" width="10" height="16" rx="1" /><rect x="40" y="18" width="10" height="16" rx="1" /><rect x="40" y="46" width="10" height="16" rx="1" /><line x1="8" y1="38" x2="54" y2="38" stroke="#222" strokeWidth="4" strokeLinecap="round" /><line x1="18" y1="18" x2="18" y2="34" stroke="#222" strokeWidth="4" strokeLinecap="round" /><line x1="10" y1="26" x2="26" y2="26" stroke="#222" strokeWidth="4" strokeLinecap="round" /></svg>), insert: '\\class{cme-col-op-wrapper}{\\class{cme-col-op-val1}{#?}\\class{cme-col-op-op}{+}\\class{cme-col-op-val2}{#?}\\class{cme-col-op-result}{#?}}', cls: 'template', directInsert: true, action: 'INSERT_CUSTOM', title: 'Fraction with Addition' },
          ...
          (domElement) => {
            ...
            const setLatex = () => {
              ...
              try {
                ...
                // Accessing mf.macros can throw "Mathfield not mounted" if MathLive hasn't fully initialized
                ...
                if (e.message && e.message.includes('mounted')) {
                  requestAnimationFrame(setLatex);
                } else {
                  console.error('Error setting latex:', e);
                }
              }
            };
